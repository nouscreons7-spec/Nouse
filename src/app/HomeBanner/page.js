...
const Banner = ({ data, interval = 5000 }) => {
  ...
  return (
    <div
      className="relative w-full h-[50vh]  lg:h-screen overflow-hidden"
      style={{
    ...
    >
      ...
      <h1 className="absolute bottom-6 left-4  text-xl font-bold md:text-4xl md:bottom-10 md:left-10">
